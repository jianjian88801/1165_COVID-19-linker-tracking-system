    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="状态名称" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="状态名称" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="状态名称" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
                                      placeholder="状态名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="kouzhaoyuyue_types";
                        ruleForm["dicName"]="状态名称";
                        this.$http({
