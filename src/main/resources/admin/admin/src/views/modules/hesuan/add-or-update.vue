            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="检测结果" prop="jianceTypes">
                        <el-select v-model="ruleForm.jianceTypes" placeholder="请选择检测结果">
                            <el-option
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='jianceTypes'){
                          this.ruleForm.jianceTypes = obj[o];
                          this.ro.jianceTypes = true;
                          continue;
                      }
                      if(o=='jianceTime'){
                          this.ruleForm.jianceTime = obj[o];
                          this.ro.jianceTime = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`hesuan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.hesuanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
