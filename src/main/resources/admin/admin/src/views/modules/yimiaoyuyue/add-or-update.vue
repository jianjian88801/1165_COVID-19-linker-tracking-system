    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yimiao'">
                    <el-form-item class="select" v-if="type!='info'"  label="疫苗" prop="yimiaoId">
                        <el-select v-model="ruleForm.yimiaoId" filterable placeholder="请选择疫苗" @change="yimiaoChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yimiao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="疫苗数量" prop="yimiaoNumber">
                        <el-input v-model="yimiaoForm.yimiaoNumber"
                                  placeholder="疫苗数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="疫苗数量" prop="yimiaoNumber">
                            <el-input v-model="ruleForm.yimiaoNumber"
            ...
            <input id="yimiaoId" name="yimiaoId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="状态" prop="yimiaoyuyueTypes">
                        <el-select v-model="ruleForm.yimiaoyuyueTypes" placeholder="请选择状态">
                            <el-option
                                v-for="(item,index) in yimiaoyuyueTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="状态" prop="yimiaoyuyueValue">
                        <el-input v-model="ruleForm.yimiaoyuyueValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yimiaoyuyue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yimiaoyuyueTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yimiaoId'){
                          this.ruleForm.yimiaoId = obj[o];
                          this.ro.yimiaoId = true;
                          continue;
                      }
                      if(o=='yimiaoyuyueTypes'){
                          this.ruleForm.yimiaoyuyueTypes = obj[o];
                          this.ro.yimiaoyuyueTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.yimiaoChange(data.data.yimiaoId)
