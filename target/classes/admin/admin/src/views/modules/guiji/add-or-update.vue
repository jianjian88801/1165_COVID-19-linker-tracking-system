...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='didian'">
                    <el-form-item class="select" v-if="type!='info'"  label="地点" prop="didianId">
                        <el-select v-model="ruleForm.didianId" filterable placeholder="请选择地点" @change="didianChange">
                            <el-option
                                    v-for="(item,index) in didianOptions"
                                    v-bind:key="item.id"
                                    :label="item.didianName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='didian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地点名称" prop="didianName">
                        <el-input v-model="didianForm.didianName"
                                  placeholder="地点名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="地点名称" prop="didianName">
                            <el-input v-model="ruleForm.didianName"
                                      placeholder="地点名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='didian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地点状态" prop="didianValue">
                        <el-input v-model="didianForm.didianValue"
                                  placeholder="地点状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="地点状态" prop="didianValue">
                            <el-input v-model="ruleForm.didianValue"
                                      placeholder="地点状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="didianId" name="didianId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="去的时间" prop="guijiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.guijiTime"
                                type="datetime"
                                placeholder="去的时间">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.guijiTime" label="去的时间" prop="guijiTime">
                            <span v-html="ruleForm.guijiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   guijiTime: [
                              { required: true, message: '去的时间不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
         ...
         this.$http({
             url: `didian/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.didianOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='didianId'){
                          this.ruleForm.didianId = obj[o];
                          this.ro.didianId = true;
                          continue;
                      }
                      if(o=='guijiTime'){
                          this.ruleForm.guijiTime = obj[o];
                          this.ro.guijiTime = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.didianChange(data.data.didianId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`guiji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.guijiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
