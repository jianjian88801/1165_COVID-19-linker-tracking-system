               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="疫苗类型" prop="yimiaoTypes">
                        <el-select v-model="ruleForm.yimiaoTypes" placeholder="请选择疫苗类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="疫苗数量" prop="yimiaoNumber">
                       <el-input v-model="ruleForm.yimiaoNumber"
                                 placeholder="疫苗数量" clearable  :readonly="ro.yimiaoNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="yimiaoContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yimiaoContent" label="备注" prop="yimiaoContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yimiaoName'){
                          this.ruleForm.yimiaoName = obj[o];
                          this.ro.yimiaoName = true;
                          continue;
                      }
                      if(o=='yimiaoTypes'){
                          this.ruleForm.yimiaoTypes = obj[o];
                          this.ro.yimiaoTypes = true;
                          continue;
                      }
                      if(o=='yimiaoNumber'){
                          this.ruleForm.yimiaoNumber = obj[o];
                          this.ro.yimiaoNumber = true;
                          continue;
                      }
                      if(o=='yimiaoContent'){
                          this.ruleForm.yimiaoContent = obj[o];
                          this.ro.yimiaoContent = true;
                          continue;
                      }
                      if(o=='insertTime'){
