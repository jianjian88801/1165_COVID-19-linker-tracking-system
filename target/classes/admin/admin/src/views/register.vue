    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">新冠病毒密接者跟踪系统注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="医护人员姓名" class="input" v-if="tableName=='yihu'">
                            <el-input v-model="ruleForm.yihuName" autocomplete="off" placeholder="医护人员姓名"  />
                        </el-form-item>
                        <el-form-item label="医护人员手机号" class="input" v-if="tableName=='yihu'">
                            <el-input v-model="ruleForm.yihuPhone" autocomplete="off" placeholder="医护人员手机号"  />
                        </el-form-item>
                        <el-form-item label="医护人员身份证号" class="input" v-if="tableName=='yihu'">
                            <el-input v-model="ruleForm.yihuIdNumber" autocomplete="off" placeholder="医护人员身份证号"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('yihu' == this.tableName && this.ruleForm.yihuPhone&&(!this.$validate.isMobile(this.ruleForm.yihuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.yihuIdNumber)&& 'yihu'==this.tableName){
