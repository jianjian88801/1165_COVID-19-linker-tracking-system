<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yihu'"  label='医护人员姓名' prop="yihuName">
               <el-input v-model="ruleForm.yihuName"  placeholder='医护人员姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yihu'"  label='医护人员手机号' prop="yihuPhone">
               <el-input v-model="ruleForm.yihuPhone"  placeholder='医护人员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yihu'"  label='医护人员身份证号' prop="yihuIdNumber">
               <el-input v-model="ruleForm.yihuIdNumber"  placeholder='医护人员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='yihu'" label='医护人员头像' prop="yihuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='健康状态' prop="jiankangTypes">
                 <el-select v-model="ruleForm.jiankangTypes" disabled placeholder='请选择健康状态'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.yihuName)&& 'yihu'==this.flag){
                             this.$message.error('医护人员姓名不能为空');
                             return
                         }

                             if( 'yihu' ==this.flag && this.ruleForm.yihuPhone&&(!isMobile(this.ruleForm.yihuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.yihuIdNumber)&& 'yihu'==this.flag){
                             this.$message.error('医护人员身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.yihuPhoto)&& 'yihu'==this.flag){
                             this.$message.error('医护人员头像不能为空');
                             return
                         }
